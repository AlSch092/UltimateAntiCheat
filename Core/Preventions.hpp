...
/*
	Preventions - The Preventions class contains a set of functions to prevent certain types of attacks, such as thread creation, APC injection, and multiple process instances.
	It also contains a function to remap the program's sections to prevent memory writing/patching.
*/
